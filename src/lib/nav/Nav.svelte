...
<script lang="ts">
	...
	import { ic_document_scanner, ic_lightbulb, ic_mail } from 'maic/two_tone';
	import Hamburger from './Hamburger.svelte';
	import Hasher, { hash, hashPlaceholder, hashes } from './Hasher.svelte';
	...
	<div class="right">
		...
		<Hamburger>
			...
			>
				...
				<Topping
					{ctx}
					icon={ic_document_scanner}
					name="Blog"
					on:click={() => {
						void goto('https://blog.ljs.lol');
					}}
				/>
				<slot name="toppings" />
			</svelte:fragment>
